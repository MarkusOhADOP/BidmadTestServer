// Rolling Behaviour Test RB-102: First two adapters fail, third succeeds
// Waterfall: [A, B, C]
// req(A) -> fail(A) -> fail(B) -> Returns C, index=0
// A and B have invalid adcode (will fail), C succeeds with 320x100
