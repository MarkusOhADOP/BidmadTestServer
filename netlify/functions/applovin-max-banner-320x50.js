...
// Device only — AppLovin SDK requires real device + test device IDs.
...
export const handler = async () => {
  return {
    ...
    body: JSON.stringify({
      ...
      type: "banner",
      ads: {
        "a1b2c3d4-0014-4000-8000-applovinmx00050": {
          adcode:
          ...
          advidx: "31534d43-vidx-0000-0000-applovinmx050",
          areaidx: "a1b2c3d4-0014-4000-8000-applovinmx00050",
          adweight: "100",
          adv_price: "1",
          order: "1",
          width: "320",
